...
public class KawaseBlurStrong : ScriptableRendererFeature
{
    [System.Serializable]
    public class KawaseBlurSettings
    {
        ...
        public string targetName = "_blurTextureStrong";
    }
    ...
    {
        scriptablePass = new CustomRenderPass("KawaseBlurStrong");
